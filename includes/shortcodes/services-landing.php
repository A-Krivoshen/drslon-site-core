	...
	<div class="krv-services-landing">
		...
		<div class="krv-services-landing-section">
			<div class="krv-landing-contact-card">
				<div class="krv-landing-avatar-wrap">
					<img class="krv-landing-avatar" src="<?php echo esc_url( home_url( '/wp-content/uploads/2026/06/drslon_avatar.png' ) ); ?>" alt="Алексей Кривошеин">
				</div>
				...
				<div class="krv-landing-contacts">
					...
					<a href="<?php echo esc_url( home_url( '/max' ) ); ?>" target="_blank" title="MAX" rel="noopener noreferrer" aria-label="MAX">
		...
		<div class="krv-services-landing-section">
			<div class="krv-landing-services" id="uslugi">
				...
				<div class="krv-landing-services-grid">
					...
					<div class="krv-landing-service-item">
						<svg class="krv-landing-service-icon" viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="3"></circle><path d="M19.4 15a1 1 0 0 0 .2 1.1l.1.1a2 2 0 1 1-2.8 2.8l-.1-.1a1 1 0 0 0-1.1.2 1 1 0 0 0-.6.9V20a2 2 0 1 1-4 0v-.2a1 1 0 0 0-.6-.9 1 1 0 0 0-1.1.2l-.1.1a2 2 0 1 1-2.8-2.8l.1.1a1 1 0 0 0 .2-1.1 1 1 0 0 0-.9-.6H4a2 2 0 1 1 0-4h.2a1 1 0 0 0 .9-.6 1 1 0 0 0-.2-1.1l-.1-.1a2 2 0 1 1 2.8-2.8l.1.1a1 1 0 0 0 1.1.2 1 1 0 0 0 .6-.9V4a2 2 0 1 1 4 0v.2a1 1 0 0 0 .6.9 1 1 0 0 0 1.1-.2l.1-.1a2 2 0 1 1 2.8 2.8l-.1.1a1 1 0 0 0-.2 1.1 1 1 0 0 0 .9.6H20a2 2 0 1 1 0 4h-.2a1 1 0 0 0-.9.6 1 1 0 0 0-.2-1.1l-.1-.1a2 2 0 1 1 2.8 2.8l-.1.1a1 1 0 0 0 1.1-.2l-.1.1a2 2 0 1 1-2.8-2.8l.1-.1a1 1 0 0 0 .2-1.1 1 1 0 0 0-.9-.6Z"></path></svg>
		...
		<div class="krv-services-landing-section">
			<div class="krv-landing-pricing">
				...
				<a class="krv-landing-pricing-button" href="<?php echo esc_url( home_url( '/contacts/' ) ); ?>" rel="noopener">
					Обсудить проект
				</a>
			</div>
		</div>
