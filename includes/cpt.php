<?php
/**
 * Custom post types + partner taxonomy.
...
/**
 * One-time rewrite flush scheduled by register_activation_hook,
 * so CPT/taxonomy permalinks work right after plugin activation
 * without re-saving permalinks manually.
 */
add_action( 'init', function () {
